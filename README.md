...
所有我做的 Android App 的安装包都放这里，手机打开 GitHub App 进这个仓库就能下。
...
同一个 App 的新版本**可以直接覆盖安装，不用卸载**。我一直用同一张签名证书，
版本号也每次递增，所以放心装。

> ⚠️ 只有一种情况要卸载：手机上装的是很早的**调试版**（体积 44 MB 那种）。
> 调试版和正式版签名不同，会报「软件包与现有软件包存在冲突」——卸载一次即可，之后一路覆盖。
